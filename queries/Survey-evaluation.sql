...
FROM
    ...
    FROM drupal_47.node
    JOIN drupal_47.webform_submitted_data data ON node.nid = data.nid AND data.data LIKE 'CS_'
    ...
    LEFT JOIN wemove_47.analytics_excluded_surveys x ON x.nid = node.nid
    WHERE x.nid IS NULL
